...
pub const EventType = enum {
    ...
    install_bootloader,
    install_post,
    install_post_step_started,
    install_post_step_succeeded,
    install_post_step_failed_retryable,
    install_post_step_failed_terminal,
    install_post_finalizer_started,
    install_post_finalizer_succeeded,
    install_post_finalizer_failed,
    install_rebooting,
    install_completed,
    install_failed,
...
pub const definitions = [_]EventDefinition{
    ...
    .{ .name = "install.post_step_started", .description = "install-post step attempt started" },
    .{ .name = "install.post_step_succeeded", .description = "install-post step attempt succeeded" },
    .{ .name = "install.post_step_failed_retryable", .description = "install-post step attempt failed and will retry", .default_level = .warn },
    .{ .name = "install.post_step_failed_terminal", .description = "install-post step failed terminally", .default_level = .err },
    .{ .name = "install.post_finalizer_started", .description = "install-post finalizer started" },
    .{ .name = "install.post_finalizer_succeeded", .description = "install-post finalizer succeeded" },
    .{ .name = "install.post_finalizer_failed", .description = "install-post finalizer failed", .default_level = .err },
    ...
    .{ .name = "boot.deploy_disabled", .description = "PXE denied because node deploy=false", .default_level = .warn },
    .{ .name = "diskless.initrd_started", .description = "diskless initrd started" },
    .{ .name = "diskless.rootfs_downloading", .description = "rootfs download in progress" },
    .{ .name = "diskless.rootfs_verified", .description = "rootfs verified" },
    .{ .name = "diskless.rootfs_mounted", .description = "rootfs mounted" },
    .{ .name = "diskless.switching_root", .description = "switch_root in progress" },
    .{ .name = "diskless.agent_configuring", .description = "node agent applying desired state" },
