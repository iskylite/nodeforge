...
pub const specs = [_]RouteSpec{
    ...
    .{ .method = "GET", .template = "/api/v1/nodes/:id/install-generations/:gen/first-boot/plan", .plane = .node, .auth = .node_session, .cache = .no_store, .log = .api },
    .{ .method = "GET", .template = "/api/v1/nodes/:id/install-generations/:gen/first-boot/payloads/:sha256", .plane = .node, .auth = .node_session, .cache = .no_store, .log = .api },
    .{ .method = "GET", .template = "/api/v1/nodes/:id/install-generations/:gen/first-boot/capsule", .plane = .node, .auth = .node_session, .cache = .no_store, .log = .api },
    .{ .method = "POST", .template = "/api/v1/nodes/:id/install-generations/:gen/first-boot/handoff", .plane = .node, .auth = .node_session, .cache = .no_store, .log = .api },
    .{ .method = "POST", .template = "/api/v1/nodes/:id/install-generations/:gen/first-boot/events", .plane = .node, .auth = .node_session, .cache = .no_store, .log = .api },
    ...
    .{ .method = "GET", .template = "/api/v1/management/nodes/:id/discovery", .plane = .management, .auth = .loopback, .cache = .no_store, .log = .api },
    .{ .method = "POST", .template = "/api/v1/management/nodes/:id/discovery", .plane = .management, .auth = .loopback, .cache = .no_store, .log = .api },
    .{ .method = "POST", .template = "/api/v1/discovery/probes/:id/facts", .plane = .node, .auth = .node_session, .cache = .no_store, .log = .api },
    ...
    .{ .method = "GET", .template = "/api/v1/management/profiles/:name/rootfs/staging", .plane = .management, .auth = .loopback, .cache = .no_store, .log = .api },
    .{ .method = "DELETE", .template = "/api/v1/management/profiles/:name/rootfs/staging", .plane = .management, .auth = .loopback, .cache = .no_store, .log = .api },
    .{ .method = "GET", .template = "/api/v1/management/profiles/:name/rootfs", .plane = .management, .auth = .loopback, .cache = .no_store, .log = .api },
    .{ .method = "GET", .template = "/api/v1/management/rootfs/stagings", .plane = .management, .auth = .loopback, .cache = .no_store, .log = .api },
