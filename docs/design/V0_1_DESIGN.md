...
[`archive/M0_M7_LEGACY_DETAILED_DESIGN.md`](../archive/M0_M7_LEGACY_DETAILED_DESIGN.md) 和各专项文档中，
实机记录归入 `validation/`；
发生冲突时，以本文定义的目标模型为准。
...
v0.1 不包含 diskless rootfs 启动和高级 post-provision runner；diskless 属于
