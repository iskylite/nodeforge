...
"$cli" --version | grep -Eq "^nodeforge $nodeforge_version \\(commit ([0-9a-f]{12}|unknown)"
"$cli" -v | grep -Fq 'built '
"$daemon" --version | grep -Eq "^nodeforged $nodeforge_version \\(commit ([0-9a-f]{12}|unknown)"
